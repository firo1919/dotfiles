...
hl.bind(mainMod .. " + SHIFT + ALT + 1",               hl.dsp.window.move({ monitor = MONITOR1 }))
hl.bind(mainMod .. " + SHIFT + ALT + 2",               hl.dsp.window.move({ monitor = MONITOR2 }))
hl.bind(mainMod .. " + SHIFT + ALT + 3",               hl.dsp.window.move({ monitor = MONITOR3 }))
...
-- Focus on workspace number (Super + 1..7)
for i = 1, NUM_WPM do
    local key = i % 10
...
-- Relative workspaces on current monitor (Super + Ctrl + 1..7)
for i = 1, NUM_WPM do
    local key = i % 10
